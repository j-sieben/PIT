...
As a powerful extension to this concept, `PIT` now supports messages in ICU format altrantively to the messages mentioned above. [Read more](Doc/icu_messages.md) about ICU messages and their integration into `PIT`.
