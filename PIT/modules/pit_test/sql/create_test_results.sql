...
using (select 'TOGGLE_CONTEXT_1' test_id,
       ...
       select 'TOGGLE_CONTEXT_2', 1, 'CONTEXT_CHANGED', 'CONTEXTCONTEXT_TEST_FULL_DEFAULT' from dual union all
       select 'TOGGLE_CONTEXT_2', 2, 'ENTER', null from dual union all  
       select 'TOGGLE_CONTEXT_2', 3, 'ENTER', null from dual union all  
       select 'TOGGLE_CONTEXT_2', 4, 'CONTEXT_CHANGED', 'CONTEXT_TEST_LOG_ONLY' from dual union all  
       select 'TOGGLE_CONTEXT_2', 5, 'CONTEXT_CHANGED', 'CONTEXT_TEST_FULL' from dual union all 
       ...
       select 'TOGGLE_CONTEXT_3', 6, 'CONTEXT_CHANGED', 'CONTEXT_DEFAULT' from dual) v
