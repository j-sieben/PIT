begin
  ...
  pit_admin.merge_message(
    ...
    p_pms_description => q'^Please refer to the error details.^',
    p_pms_pse_id => 30,
  ...
  pit_admin.merge_message(
    ...
    p_pms_description => q'^The attachment is of a type that is not supported by PIT_MAIL output module.^',
    p_pms_pse_id => 30,
    p_pms_pml_name => 'AMERICAN',
  ...
  pit_admin.merge_message(
    ...
    p_pms_description => q'^Pleae refer to the error details.^',
    p_pms_pse_id => 30,
    p_pms_pml_name => 'AMERICAN',
    p_error_number => -20000
  );
  ...
  pit_admin.merge_message(
    ...
    p_pms_description => q'^Errors during the initialization phase of PIT_MAIL are normally due to invalid parameter values. Please check the parameters.^',
    p_pms_pse_id => 30,
    p_pms_pml_name => 'AMERICAN',
    p_error_number => -20000
  );
  ...
  pit_admin.merge_message(
    ...
    p_pms_description => q'^Since version 11g, Oracle requires an explicit grant to access a network ressource. Please make sure that the database is allowed to access the mail server.^',
    p_pms_pse_id => 30,
    p_pms_pml_name => 'AMERICAN',
    p_error_number => -20000
  );
  ...
  pit_admin.merge_message(
    ...
    p_pms_description => q'^The mail server is allowed to be connected, but it is impossible to do so. Please check the parameters and whether the mail server is running.^',
    p_pms_pse_id => 30,
    p_pms_pml_name => 'AMERICAN',
    p_error_number => -20000
  );
