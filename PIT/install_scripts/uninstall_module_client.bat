...
set /p Module=Enter module name to revoke:

set nls_lang=GERMAN_GERMANY.AL32UTF8

sqlplus %InstallUser%/"%InstallPWD%"@%SID% @install_scripts/revoke_module_client.sql %InstallUser% %RemoteUser% %Module%

sqlplus %RemoteUser%/"%RemotePWD%"@%SID% @install_scripts/unregister_module_client.sql %InstallUser% %RemoteUser% %Module%
popd
