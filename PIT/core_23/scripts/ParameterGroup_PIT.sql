...
begin
  ...
  param_admin.edit_parameter(
    ...
    p_par_pgr_id => 'PIT',
    p_par_description => 'Named context, switches logging on [LOG_LEVEL|TRACE_LEVEL|TRACE_TIMING_FLAG (true/false)|MODULE_LIST]',
    p_par_string_value => '70|50|' || true || '|PIT_CONSOLE',
    p_par_boolean_value => null,
    p_par_is_modifiable => null
  );
  ...
  param_admin.edit_parameter(
    ...
    p_par_pgr_id => 'PIT',
    p_par_description => 'Named context, default values [LOG_LEVEL|TRACE_LEVEL|TRACE_TIMING_FLAG (true/false)|MODULE_LIST]',
    p_par_string_value => '30|10|false|PIT_TABLE:PIT_APEX',
    p_par_boolean_value => null,
    p_par_is_modifiable => null
  );
  ...
  param_admin.edit_parameter(
    ...
    p_par_pgr_id => 'PIT',
    p_par_description => 'Named context, switches logging off [LOG_LEVEL|TRACE_LEVEL|TRACE_TIMING_FLAG (true/false)|MODULE_LIST]',
    p_par_string_value => '10|10|false|',
    p_par_boolean_value => null,
    p_par_is_modifiable => null
  );
  ...
  param_admin.edit_parameter(
    ...
    p_par_pgr_id => 'PIT',
    p_par_description => 'Flag to indicate whether PIT package method calls should be discarded from the call and error stack',
  ...
  param_admin.edit_parameter(
    ...
    p_par_pgr_id => 'PIT',
    p_par_description => 'Comma separated list of additional package names that should be discarded from the call and error stack',
    p_par_string_value => '',
    p_par_is_modifiable => null
  );
  ...
  param_admin.edit_parameter(
    ...
    p_par_pgr_id => 'PIT',
    p_par_description => 'Template to create a call stack string',
...
------- --------------- ----------------------------------------------^',
  ...
  param_admin.edit_parameter(
    ...
    p_par_pgr_id => 'PIT',
    p_par_description => 'Template to create a error stack string',
