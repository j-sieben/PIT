  ...
  cursor delete_object_cur is
          select object_name name, object_type type
           ...
           where object_name in (
                 ...
                 'pit_pmg_language_v', 'PIT_MESSAGE_ACCESS_V', 'PIT_MESSAGE_LANGUAGE_V', 'PIT_MESSAGE_V', 'PIT_MESSAGE_GROUP_V', 'PIT_TRANSLATABLE_ITEM_V', 'PIT_MESSAGE_SEVERITY_V', 'PIT_TRACE_LEVEL_V', '', -- Views
                 'PIT_MESSAGE', 'PIT_MESSAGE_TEXT', 'PIT_MESSAGE_LANGUAGE', 'PIT_MESSAGE_SEVERITY', 'PIT_MESSAGE_STATUS', 'PIT_TRACE_LEVEL', 'PIT_MESSAGE_GROUP', 'PIT_TRANSLATABLE_ITEM', 'PIT_TRANSLATION_SCOPE',  -- Tables
                 'MSG',  -- Synonyms
