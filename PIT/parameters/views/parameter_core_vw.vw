create or replace view parameter_core_vw as
...
comment on table parameter_core_vw is 'View to combine default, realm and local parameters. Published to allow a client to read realm parameters';
