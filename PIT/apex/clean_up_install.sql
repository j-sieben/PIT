  ...
  cursor delete_object_cur is
          select object_name name, object_type type
           ...
           where object_name in (
                 ...
                 'PIT_UI_ADMIN_PAR', 'PIT_UI_ADMIN_PAR_REALM', 'PIT_UI_ADMIN_PIT_ACTIVE_CONTEXT', 'PIT_UI_ADMIN_PIT_CONTEXT', 'PIT_UI_ADMIN_PIT_MODULE', 'PIT_UI_ADMIN_PIT_TOGGLE', 
                 'PIT_UI_ADMIN_PMS', 'PIT_UI_EDIT_CONTEXT', 'PIT_UI_EDIT_MESSAGE_TRANS', 'PIT_UI_EDIT_MODULE', 'PIT_UI_SET_REALM', 
                 'PIT_UI_EDIT_PAR', 'PIT_UI_EDIT_PAR_REALM', 'PIT_UI_EDIT_REALM', 'PIT_UI_EDIT_PGR', 'PIT_UI_EDIT_PMG', 'PIT_UI_EDIT_PMS', 'PIT_UI_EDIT_TOGGLE', 
                 'PIT_UI_LANG_SETTINGS_DEFAULT', 'PIT_UI_LIST_ACTIVE_FOR_PAGE', 
                 'PIT_UI_LOV_AVAILABLE_PACKAGES', 'PIT_UI_LOV_BOOLEAN_TRI_STATE', 'PIT_UI_LOV_CONTEXT', 'PIT_UI_LOV_MESSAGE_GROUP', 
                 'PIT_UI_LOV_MESSAGE_LANGUAGE', 'PIT_UI_LOV_MESSAGE_SEVERITY', 'PIT_UI_LOV_OUTPUT_MODULES', 'PIT_LOV_UI_UTTM_TYPE',
                 'PIT_UI_LOV_PARAMETER_GROUP', 'PIT_UI_LOV_PARAMETER_REALM', 'PIT_UI_LOV_PARAMETER_TYPE', 'PIT_UI_LOV_TRACE_LEVEL', -- Views
                 '',   -- Tabellen
                 '',  -- Synonyme
                 '' -- Sequenzen
                 )
