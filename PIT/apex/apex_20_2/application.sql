...
--   Date and Time:   13:23 Tuesday July 26, 2022
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(116756863635249806)
...
begin
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(117200563707153734)
,p_lov_name=>'LOV_UTTM_TYPE'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
,p_query_table=>'PIT_UI_LOV_UTTM_TYPE'
,p_return_column_name=>'R'
,p_display_column_name=>'D'
,p_default_sort_column_name=>'D'
,p_default_sort_direction=>'ASC'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(117167676371477106)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(117167898735477108)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(117167676371477106)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(117167796361477107)
,p_name=>'P16_UTTM_TYPE_LIST'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(117167676371477106)
,p_prompt=>'Parametergruppe'
,p_display_as=>'NATIVE_SHUTTLE'
