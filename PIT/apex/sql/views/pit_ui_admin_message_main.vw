create or replace view pit_ui_admin_message_main as
  with message_raw as(
       select distinct pms.rowid row_id, pms_name, pms_pmg_name, pms_pml_name, pms_pse_id, pms_custom_error, dbms_lob.substr(pms_text, 4000, 1) pms_text, src.name pms_used_at,
